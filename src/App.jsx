            ...
            <form onSubmit={onSubmit}>
                ...
                */}
                <input
                    ...
                    onChange={onChange}
                    value={todo}
                    // 1. input에서 엔터를 치면, onSubmit이 발동이되고
                    // 2. onSubmit 안에 있는 setTodo를 실행시켜서 todo의 값을 ""(빈 스트링)으로 바꾸고
                    // 3. 리액트 엔진이 todo가 사용되고 있는 input의 value갑을 다시 그리고
                ...
                <ul>
                    {/*
                        ...
                        <li>태그가 찍히면서, 그안에 요소(string)의 내용을 출력해주면 됨 => .map() 메소드
                        .map() : 요소를 순회하면서 함수 return 안의 내요을 반환함
